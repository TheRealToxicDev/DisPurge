...
module.exports.run = async (client , message, args) => {
    ...
    await message.channel.bulkDelete('70').catch(() => {})

    let success = new MessageEmbed()
      success.setAuthor('Purge Complete', EmbedConfig.image)
      success.setColor(EmbedConfig.blurple)
      success.setDescription('I have purged `70` messages from this channel.')
...
module.exports.help = {
    ...
    category: "purging",
    aliases: ['p70'],
    description: "Bulk Delete 70 messages under 14 days old!",
    example: "``purge70``"
}
