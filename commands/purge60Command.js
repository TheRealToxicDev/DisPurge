...
module.exports.run = async (client , message, args) => {
    ...
    await message.channel.bulkDelete('60').catch(() => {})

    let success = new MessageEmbed()
      success.setAuthor('Purge Complete', EmbedConfig.image)
      success.setColor(EmbedConfig.blurple)
      success.setDescription('I have purged `60` messages from this channel.')
...
module.exports.help = {
    ...
    category: "purging",
    aliases: ['p60'],
    description: "Bulk Delete 50 messages under 14 days old!",
    example: "``purge60``"
}
