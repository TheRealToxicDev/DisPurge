...
module.exports.run = (client , message, args) => {
 ...
 let embed = new MessageEmbed()
   ...
   embed.addField('Invite HyperLink', '[Click Here Boii](https://api.toxicdev.me/bots/dispurge/inv)', true)
   embed.addField('Invite Link (Mobile Users)', 'https://api.toxicdev.me/bots/dispurge/inv', true)
