...
module.exports.run = async (client , message, args) => {
    ...
    await message.channel.bulkDelete('90').catch(() => {})

    let success = new MessageEmbed()
      success.setAuthor('Purge Complete', EmbedConfig.image)
      success.setColor(EmbedConfig.blurple)
      success.setDescription('I have purged `90` messages from this channel.')
...
module.exports.help = {
    ...
    category: "purging",
    aliases: ['p90'],
    description: "Bulk Delete 90 messages under 14 days old!",
    example: "``purge50``"
}
