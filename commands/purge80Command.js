...
module.exports.run = async (client , message, args) => {
    ...
    await message.channel.bulkDelete('80').catch(() => {})

    let success = new MessageEmbed()
      success.setAuthor('Purge Complete', EmbedConfig.image)
      success.setColor(EmbedConfig.blurple)
      success.setDescription('I have purged `80` messages from this channel.')
...
module.exports.help = {
    ...
    category: "purging",
    aliases: ['p80'],
    description: "Bulk Delete 80 messages under 14 days old!",
    example: "``purge80``"
}
